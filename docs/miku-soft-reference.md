...
Project-specific decisions, checked reference revisions, upstream compatibility,
and verification results are recorded in this repository's development notes
and TODO.
